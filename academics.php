    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
          ...
          <div class="col">
            <div class="card mb-3 text-center">
              <a href="javascript:void()" onclick="location.href='create-time-table.php'" class="nav-links text-uppercase bg-white p-3 px-4">class time table</a>
            </div>
          </div>
            ...
            $("#btntems").on('click', function(e) {
              ...
              if (smasterscls == "") {
                ...
                $.ajax({
                  ...
                  type: "POST",
                  data: {
                    term_titles: smasterscls,
                    term_ids: samasterid,
                    instute_id: shopids,
                    sesions_term: sesnsofrm
                  },
                  success: function(data) {
                    //$("#clsses").html(data);
                    if (data == 1) {
                      Swal.fire({
                        position: 'top-end',
                        icon: 'success',
                        title: 'Term / Samester / Month Successfully Submited',
                        showConfirmButton: false,
                        timer: 1500
                      });
                      ...
                      Swal.fire({
                        position: 'top-end',
                        icon: 'error',
                        title: 'Term / Samester / Month is not Saved',
                        showConfirmButton: false,
                        timer: 1500
                      });
                      $("#terform").trigger("reset");
            ...
            $("#sve-section-btn").on('click', function(e) {
              ...
              if (sectnsnmt == "" || sectnclas == "" || sectnnumbr == "") {
                ...
                $.ajax({
                  ...
                  type: "POST",
                  data: {
                    section_class: sectnclas,
                    sectn_title: sectnsnmt,
                    school_code: instutsecn,
                    section_numbr: sectnnumbr
                  },
                  success: function(data) {
                    //$("#clsses").html(data);
                    if (data == 1) {
                      Swal.fire({
                        position: 'top-end',
                        icon: 'success',
                        title: 'Section Successfully Submited',
                        showConfirmButton: false,
                        timer: 1500
                      });
                      $("#sectnform").trigger("reset");
                      loadsections();
                    } else {
                      Swal.fire({
                        position: 'top-end',
                        icon: 'error',
                        title: 'Section is not Saved',
                        showConfirmButton: false,
                        timer: 1500
                      });
                      $("#sectnform").trigger("reset");
          ...
          <div class="row">
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-3 col-xxl-2 mb-3">
              ...
              <select class="form-select text-capitalize" id="closid">
                ...
                if ($cnst == 0) {
                  echo "<div class='alert alert-success text-capitalize'>There are no class generate.</div>";
                }
            ...
            $("#btnsujbts").on('click', function(e) {
              ...
              if (subjtitle == "") {
                ...
                $.ajax({
                  ...
                  type: "POST",
                  data: {
                    subject_titles: subjtitle,
                    institutes_id: subjinstid,
                    sbjcls_id: sbclsid
                  },
                  success: function(data) {
                    //$("#clsses").html(data);
                    if (data == 1) {
                      Swal.fire({
                        position: 'top-end',
                        icon: 'success',
                        title: 'Subject Successfully Submited',
                        showConfirmButton: false,
                        timer: 1500
                      });
