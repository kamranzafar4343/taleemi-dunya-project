...
<table class="table table-responsive table-stiped w-100 mb-3 bg-apna">
    <tr align="center">
...
<table class="table table-responsive table-striped w-100">
    <tr align="center" style="background:hsl(35, 100%, 50%);">
    ...
    <tr style="background:hsl(35, 100%, 70%);">
        ...
        <th style="border:1px solid hsl(25, 100%, 50%);">Discount</th>
        <th style="border:1px solid hsl(25, 100%, 50%);">T.Amount</th>
        <th style="border:1px solid hsl(25, 100%, 50%);">Received</th>
        <th style="border:1px solid hsl(25, 100%, 50%);">Remaining</th>
        <th style="border:1px solid hsl(25, 100%, 50%);">Fee Status</th>
        <th style="border:1px solid hsl(25, 100%, 50%);">Month</th>
    </tr>
<?php
$ab =1;
if(isset($_GET['id'])){
...
<tr style="background:hsl(35, 100%, 80%);">
    ...
    <td style="border:1px solid hsl(25, 100%, 50%);"><?php echo $previous_balance; ?></td>
    <td style="border:1px solid hsl(25, 100%, 50%);"><?php echo $discounts; ?></td>
    <td style="border:1px solid hsl(25, 100%, 50%);"><?php echo $total_amount; ?></td>
    <td style="border:1px solid hsl(25, 100%, 50%);"><?php echo $receive_monthly; ?></td>
    <td style="border:1px solid hsl(25, 100%, 50%);"><?php echo $remaing_balance; ?></td>
    <td style="border:1px solid hsl(25, 100%, 50%);" class="text-capitalize fw-bold"><?php echo $fees_status; ?></td>
