...
<div class="container-fluid">
    <div class="row">
<?php
$sl_garly = mysqli_query($con,"select * from syllabus where instituteId='$instituteId' && roll_number='$roll_num'");
...
<a href="#"data-bs-toggle="modal" data-bs-target="#pdfs<?php echo $id; ?>" class="nav-link">
    <embed src="../syllabus/<?php echo $links; ?>" width="100%" style="height:200px;overflow:hidden;"  type="application/pdf" frameBorder="0" scrolling="auto"/>
...
<a href="#"data-bs-toggle="modal" data-bs-target="#lect<?php echo $id; ?>" class="nav-link">
    <img src="../syllabus/<?php echo $links; ?>" class="img-fluid" width="100%" style="height:200px;overflow:hidden;">
    <div class="card-text text-capitalize bg-apna py-2"><?php echo $nme; ?></div>
</a>
<?php } ?>
    </div>
...
<div class="row">
    <div class="col">
<embed src="../syllabus/<?php echo $links; ?>" width="100%" style="overflow:hidden;"  type="application/pdf" frameBorder="0" scrolling="auto"/>
    </div>
</div>
      </div>
...
<div class="row">
    <div class="col">
<img src="../syllabus/<?php echo $links; ?>" class="img-fluid">
    </div>
</div>
      </div>
