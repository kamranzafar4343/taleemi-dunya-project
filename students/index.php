...
if (isset($_POST['login_btn'])){
	$user = $_POST['user'];
	$pass = $_POST['pass'];
$log_query = mysqli_query($con,"select * from studentPortal where bForm='$user' && roll_num='$pass'");
...
<div class="text-center p-3">
      <h1 class="fw-bold fs-1 mt-3 text-apna text-uppercase">student Portal</h1>
</div>
<div class="pb-4 text-center text-white text-capitalize" style="font-size:0.7rem;">Dear Student Please Login Your LMS.</div>
