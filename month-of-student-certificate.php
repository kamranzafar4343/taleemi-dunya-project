...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active text-capitalize" aria-current="page"> student of the month certificate</li>
  </ol>
</nav>                
            </div>
        </div>
...
<div class="row">
<h4 class="fs-4 fw-bold text-uppercase mb-3 mt-3 text-white" style="border-bottom:2px dashed white;">student of the month certificate</h4>
<?php
if(isset($_GET['id'])){
    $ids = $_GET['id'];
...
<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12 datas">
    <div class="card">
        <img src="logo/student-of-the-month-certificate.webp" class="card-img-top">
...
Proud To Be Present This Student Of Month Certificate To <span class="text-danger text-uppercase fs-6"><?php echo $studentName; ?></span> Class<br><br> <span class="text-danger text-uppercase fs-6"><?php echo $class_name; ?></span> Section <span class="text-danger text-uppercase fs-6"><?php echo $section; ?></span> For Excellence, Achievement, Attendance And Overall<br><br> Being An Exceptional Student For The Month Of <span class="text-danger text-uppercase fs-6"><?php echo date("F"); ?></span> <span class="text-danger text-uppercase fs-6"><?php echo $session; ?></span>.
        </h6><br><br>
