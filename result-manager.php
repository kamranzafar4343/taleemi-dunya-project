...
<img class="img-fluid" src="student_imgs/<?php if(!empty($stu_image)){ if($stu_image == "None"){ echo "users.jpg"; }else{ echo $stu_image; } }else{ echo "users.jpg"; } ?>">
        <div class="card-body p-1" style="background-color:hsl(35,100%,80%);">
<table class="w-100">
    <tr align="center"><th colspan="2" class="fs-6 text-uppercase"><?php echo $student_name; ?></th></tr>
    <tr><th style="border:1px solid hsl(25,100%,5%);">F.Name</th><td style="border:1px solid hsl(25,100%,5%);"><?php echo $father_name; ?></td></tr>
    <tr><th style="border:1px solid hsl(25,100%,5%);">Class</th><td style="border:1px solid hsl(25,100%,5%);"><?php echo $class_name; ?></td></tr>
    <tr><th style="border:1px solid hsl(25,100%,5%);">Term</th><td style="border:1px solid hsl(25,100%,5%);"><?php echo $term; ?></td></tr>
    <tr><th style="border:1px solid hsl(25,100%,5%);">Roll#</th><td style="border:1px solid hsl(25,100%,5%);"><?php echo $rollnumber; ?></td></tr>
</table>
    <div class="d-flex">
        <div class="p-1 flex-fill text-center">
<a href="result-edit-by-card?id=<?php echo $id; ?>" target="_blank" title="Edit Result">
    <i class="fa fa-edit text-success"></i>
</a>
        </div>
        <div class="p-1 flex-fill text-center">
<a href="del-result-by-card?id=<?php echo $id; ?>" title="Delete Result">
    <i class="fa fa-trash-alt text-danger"></i> 
</a>
        </div>
        <div class="p-1 flex-fill text-center">
 <a href="view-result-card-by-student?id=<?php echo $id; ?>" target="_blank" title="View Result Card">
