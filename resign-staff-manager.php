...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active text-capitalize" aria-current="page"> resign staff manager</li>
  </ol>
</nav>                
            </div>
        </div>
...
<?php    
$b = 1;
$sl_stud = mysqli_query($con,"select * from resignStaff where instituteId='$userId'");
...
if(!empty($rows['staffimage'])){ $staffimage = $result['staffimage']; }else{ $staffimage = "users.jpg"; }
?>
<tr align="center" style="background:hsl(35, 100%, 80%);">
    ...
    <td style="border:1px solid hsl(25, 100%, 50%);"><a href="resign-staff-rejoin?id=<?php echo $stafid; ?>" class="btn btn-success"><i class="fa-solid fa-plus"></i> Rejoin</a></td>
