...
.modal-content, .form-control, .form-select, .card, .btn{
    border-radius:0vh;
}
.modal-header{
    border-bottom:none;
...
body, .form-control,.form-control:focus, .form-select{
  ...
  <div class="form-outline">
      <label class="form-label text-white" for="form2Example22">Select login Role</label>
        <select class="form-select text-capitalize text-warning" name="rols">
            <option><?php echo $rols_cookie; ?></option>
...
<p class="text-white mt-4" align="justify">Taleemi Portal is a well developed school management system powered by Taleemi Dunya that helps you to manage your academic institutions. It's simplifies daily routine tasks and reporting. It improves interaction between management, teachers, parents and students through portal with an integrated database.</p>
<div class="mt-4 d-grid">
    <button class="text-uppercase btn btn-apna" data-bs-toggle="modal" data-bs-target="#signup">request a demo</button>
</div>
                    </div>
                </div>
            </div>
...
if($inst_sing){ echo "<script>swal.fire('Good Job!', 'Successfully Signup!', 'success');</script>"; }else{ echo "<script>swal.fire('Ooops...', 'Username and Password is Wrong!', 'error');</script>"; }    
}
