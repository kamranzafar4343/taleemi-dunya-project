...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb bg-dark p-3">
    ...
    <li class="breadcrumb-item"><a class="text-white text-capitalize text-decoration-none" href="javascript:void()" onclick="location.href='samesterly-challan-manager'">samesterly challan manager</a></li>
    <li class="breadcrumb-item active text-capitalize" aria-current="page"> Challan form</li>
  </ol>
</nav>
<?php
if(isset($_GET['id'])){
    $ids = $_GET['id'];
    $sl_spec = mysqli_query($con,"select * from fee_collection where id='$ids' && instituteId='$userId' && challan_status='samester' order by id desc");
...
<tr>
  ...
  <th style="padding:2px;font-size:0.7rem;">Semester Fee</th>
