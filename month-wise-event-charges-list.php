...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb bg-dark p-3">
    ...
    <li class="breadcrumb-item active text-capitalize" aria-current="page"> monthly event charges list </li>
  </ol>
</nav>
...
<select class="text-capitalize form-select" id="sesins">
<?php
...
<div class="fetch-other-charges-list datas"></div>
</div>
...
e.preventDefault();
var mnths = $(".mnths").val();
var sesin = $("#sesins").val();
var instids = $(".instids").val();

$.ajax({
    url: 'ajax/month-wise-event-charges-list.php',
    type: "POST",
