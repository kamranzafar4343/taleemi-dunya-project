...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb bg-dark p-3">
    ...
    <li class="breadcrumb-item active text-capitalize" aria-current="page"> print monthly challan type-I</li>
  </ol>
</nav>
