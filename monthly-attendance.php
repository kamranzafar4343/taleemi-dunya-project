...
<?php } ?>
    ...
    <div class="col-6 col-sm-4 col-md-3 col-lg-2 col-xl-2 col-xxl-2">
        <div class="d-grid mt-4">
            <button id="btngente" type="submit" class="btn btn-apna text-uppercase"><i class="fas fa-redo"></i> Generate</button>
        </div>
    </div>    
</div>
    </form>
...
Toast.fire({
  ...
  title: "Please Select Section!"
    ...
    $.ajax({
url: 'ajax/fetch-monthly-report.php',
type: "POST",
data: {aply_cles:cls,aply_sectin:strngs,aply_inst:instutes,aply_sesin:sesn,aply_months:mnth},
success: function(attdnreport){ $(".monthly-class-attendance-list").html(attdnreport); }
    });
}
...
<div class="monthly-class-attendance-list datas"></div>
<div class="row">
        <div class="col">
