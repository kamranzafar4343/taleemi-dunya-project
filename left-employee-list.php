...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active text-capitalize" aria-current="page"> left employees</li>
  </ol>
</nav>                
            </div>
        </div>
...
$newdt = date("j-m-Y");
$sl_stud = mysqli_query($con,"select * from leftStaff where instituteId='$userId' order by id desc");
