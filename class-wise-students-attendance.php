...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active text-capitalize" aria-current="page"> class wise student attendance report</li>
  </ol>
</nav>
            </div>
        </div>
...
<table class="table table-reponsive w-100" style='background:hsl(35, 100%, 80%);'>
    <thead>
        ...
        <tr align="center">
            <th colspan="10" class="fs-5">Student Attendance Report <?php echo $dates; ?></th>
        </tr>
        <tr class="bg-apna">
...
<?php
$at=1;
$sl_attendance = mysqli_query($con,"select * from attandance where instituteId='$instid' && class='$cles' && section='$sectn' && session='$sesin' && date='$dates'");
