...
<?php } ?>
    ...
    <div class="col-12 col-sm-6 col-md-4 col-lg-2 col-xl-2 col-xxl-2">
        <label class="text-capitalize fs-6">term / samester / month</label>
...
$.ajax({
url: 'ajax/fetch-exame-award-list-record.php',
type: "POST",
data: {inst_id:inst,aply_sesion:sesn,aply_trms:temss,apli_cls:cls,sectns:strngs},
