...
<div class="col-6 col-sm-4 col-md-3 col-lg-2 col-xl-2 col-xxl-2 mb-3">
    <div class="card bg-white">
        <div class="d-flex">
            ...
            <div class="p-2 text-center flex-fill fs-6 text-uppercase fw-bold">Class ID</div>
            <div class="p-2 flex-fill text-center">Del</div>
        </div>
        <div class="d-flex">
            <div class="p-2 text-center flex-fill fs-6 text-uppercase"><?php echo $class_name; ?></div>
            <div class="p-2 text-center flex-fill fs-6 text-uppercase"><?php echo $id; ?></div>
            <div class="p-2 flex-fill text-center">
<?php if($institute_id == 758948){ ?>
<a href="#"><i class="fa fa-trash text-danger"></i></a> 
<?php }else{ ?>
<a href="delete-class?id=<?php echo $id; ?>"><i class="fa fa-trash-alt text-danger"></i></a>
<?php } ?>
            </div>
        </div>
        <div class="d-flex">
            <div class="p-2 text-center flex-fill fs-6 text-uppercase fw-bold">Duration</div>
            <div class="p-2 text-center flex-fill fs-6"><?php echo $duration; ?></div>
        </div>
        <div class="d-grid">
            <a href="class-edit?id=<?php echo $id; ?>" class="btn btn-success text-uppercase"><i class="fa fa-edit"></i> update</a>
        </div>
    </div>
</div>
<?php } ?>
