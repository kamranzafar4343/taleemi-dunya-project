...
$sl_remdr = mysqli_query($con,"select * from reminders where instituteId='$inst_ds' && user_role='$rol_s'");
...
<div class="alert alert-success" role="alert">
  ...
  <p class="mb-0">
      <div class="d-grid">
<a href="del-reminder?id=<?php echo $remid; ?>" class="btn btn-danger">
...
}else{ echo "<div class='text-capitalize alert alert-success'>there are no remider.</div>"; }
?>