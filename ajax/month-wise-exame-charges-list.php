...
$selct_othr_list = mysqli_query($con,"select * from otherChargesPaid where months='$chrge_months' && instituteId='$institut_ids' && type='4'");
...
<?php }
$sel_othr_list = mysqli_query($con,"select * from otherChargesPaid where months='$chrge_months' && instituteId='$institut_ids' && type='4'");
