...
$fuls = '<table class="table table-responsive w-100"><tr class="bg-apna" align="center"><th style="border:1px solid hsl(25, 100%, 50%);">#</th><th style="border:1px solid hsl(25, 100%, 50%);">Image</th><th style="border:1px solid hsl(25, 100%, 50%);">Roll No.</th><th style="border:1px solid hsl(25, 100%, 50%);">Session</th><th style="border:1px solid hsl(25, 100%, 50%);">Student Name</th><th style="border:1px solid hsl(25, 100%, 50%);">Father Name</th><th style="border:1px solid hsl(25, 100%, 50%);">Class</th><th style="border:1px solid hsl(25, 100%, 50%);">Section</th><th style="border:1px solid hsl(25, 100%, 50%);">Previous</th><th style="border:1px solid hsl(25, 100%, 50%);">Fee</th><th style="border:1px solid hsl(25, 100%, 50%);">Installments</th></tr>';
...
$class_name = $rel['class_name'];
    ...
    <tr style="background:hsl(35, 100%, 80%);">
        ...
        <td style="border:1px solid hsl(25, 100%, 50%);"><input type="text" onkeypress="isInputNumber(event)" value="'.$actual_fee.'" name="mfee[]" class="form-control"></td>
        <td style="border:1px solid hsl(25, 100%, 50%);"><select name="instlmnt[]" class="form-select text-capitalize">
<option class="text-capitalize" value="">---select Installment---</option>
<option class="text-capitalize" value="1">1 Installment</option>
<option class="text-capitalize" value="2">2 Installment</option>
<option class="text-capitalize" value="3">3 Installment</option>
<option class="text-capitalize" value="4">4 Installment</option>
<option class="text-capitalize" value="5">5 Installment</option>
<option class="text-capitalize" value="6">6 Installment</option>
<option class="text-capitalize" value="7">7 Installment</option>
<option class="text-capitalize" value="8">8 Installment</option>
<option class="text-capitalize" value="9">9 Installment</option>
<option class="text-capitalize" value="10">10 Installment</option>
<option class="text-capitalize" value="11">11 Installment</option>
<option class="text-capitalize" value="12">12 Installment</option>
        </select></td>
...
/*
$.ajax({
    url: 'ajax/inserted-challan-in-fee-collection-samestrly.php',
    type: "POST",
    data: {inst_ids:instId,frm_img:imgs,fml_id:fmly,rol_nm:rlnumbr,yer:sesin,st_nme:sname,fthr_nme:fname,apl_cls:clss,sectn:setn,month_fe:mfee,blanc:prevbalance,manth:monhs},
