...
<a href="load-result?id=<?php echo $roll_no; ?> && trms=<?php echo $aply_trms; ?> && clase=<?php echo $aply_cles;?> && sectin=<?php echo $sectns;?> && seisn=<?php echo $aply_sesin;?>" target="_blank" class="btn btn-success text-uppercase">
...
<?php }else{ echo "<div class='alert alert-success'>there are no record found!</div>"; } ?>