...
?>
<div class='col-12 mb-3' style="height:700px;overflow:hidden;">
          <table class='w-100 bg-white'>
            <tr align='center'>
              <td  width='50'><img src='portal-admins/institute-logos/<?php echo $logo; ?>' class='img-fluid'></td>
                    <td colspan='2' style="border-right:1px dashed black;">
<div class="fs-6 fw-bold text-uppercase"><?php echo $institute_name; ?></div>
<div class="text-uppercase" style="font-size:0.7rem;"><?php echo $campus; ?></div>
                    </td>
              <td></td>
              <td  width='50'><img src='portal-admins/institute-logos/<?php echo $logo; ?>' class='img-fluid'></td>
                    <td colspan='2' style="border-right:1px dashed black;">
...
<div class="text-uppercase" style="font-size:0.7rem;"><?php echo $campus; ?></div>
            ...
            <tr align='center'>
              ...
              <th width='20'></th>
              <th style="padding:2px;font-size:0.7rem;border-right:1px dashed black;" colspan='3'><span class='text-uppercase'>Institute Copy</span></th>
              <th width='20'></th>
              <th style="padding:2px;font-size:0.7rem;" colspan='3'><span class='text-uppercase'>Parents Copy</span></th>
            </tr>
            <tr align='center'>
              <th style="padding:2px;border-right:1px dashed black;" colspan='3'>
                  <span class='text-uppercase' style="font-size:0.7rem;"><?php echo $account_detail; ?></span>
                </th>
              <th width='20'></th>
              <th style="padding:2px;border-right:1px dashed black;" colspan='3'>
                  <span class='text-uppercase' style="font-size:0.7rem;"><?php echo $account_detail; ?></span>
            ...
            <tr align='center'>
              <th style="border:1px solid black;padding:2px;font-size:0.7rem;border-right:1px dashed black;" colspan='3'><span class='text-uppercase'><?php echo $student_name; ?></span></th>
              <th width='20'></th>
              <th style="border:1px solid black;padding:2px;font-size:0.7rem;border-right:1px dashed black;" colspan='3'><span class='text-uppercase'><?php echo $student_name; ?></span></th>
              <th width='20'></th>
              <th style="border:1px solid black;padding:2px;font-size:0.7rem;" colspan='3'><span class='text-uppercase'><?php echo $student_name; ?></span></th>
            </tr>
            <tr>
                <th colspan="30" style="font-size:0.1rem;"></th>
            </tr>
<tr>
  <th colspan="2" style="padding:2px;font-size:0.7rem;">Father Name</th>
  <td colspan="1" style="padding:2px;font-size:0.7rem;border-right:1px dashed black;" class="text-capitalize"><?php echo $father_name; ?></td>
  <td></td>
  <th colspan="2" style="padding:2px;font-size:0.7rem;">Father Name</th>
...
<tr>
  <th colspan="2" style="padding:2px;font-size:0.7rem;">Roll#</th>
    <td style="padding:2px;font-size:0.7rem;border-right:1px dashed black;" class="text-capitalize">
      <?php echo $rollno; ?> <span style="font-size:0.7rem;">(Ch# <?php echo $at++; ?>)</span>
    </td>
  <td></td>
  <th colspan="2" style="padding:2px;font-size:0.7rem;">Roll#</th>
    <td style="padding:2px;font-size:0.7rem;border-right:1px dashed black;" class="text-capitalize">
  ...
  <td></td>
  <th colspan="2" style="padding:2px;font-size:0.7rem;">Roll#</th>
  <td style="padding:2px;font-size:0.7rem;" class="text-capitalize"><?php echo $rollno; ?> <span style="font-size:0.7rem;">(Ch# <?php echo $at++; ?>)</span> </td>
</tr>
<tr>
  <th colspan="2" style="padding:2px;font-size:0.7rem;">Class/Sec</th>
...
<tr>
  ...
  <td style="padding:2px;font-size:0.7rem;border-right:1px dashed black;" class="text-capitalize"><?php if(!empty($month)){ echo $monthName; }else{ echo date("M");} ?></td>
  <td></td>
  <th colspan="2" style="padding:2px;font-size:0.7rem;">Challan Month</th>
  <td style="padding:2px;font-size:0.7rem;border-right:1px dashed black;" class="text-capitalize"><?php if(!empty($month)){ echo $monthName; }else{ echo date("M");} ?></td>
  <td></td>
  <th colspan="2" style="padding:2px;font-size:0.7rem;">Challan Month</th>
  <td style="padding:2px;font-size:0.7rem;" class="text-capitalize"><?php if(!empty($month)){ echo $monthName; }else{ echo date("M");} ?></td>
</tr>
<tr>
  <th colspan="2" style="padding:2px;font-size:0.7rem;">Issue Date</th>
  <td style="padding:2px;font-size:0.7rem;border-right:1px dashed black;" class="text-capitalize"><?php echo $dates; ?></td>
  <td></td>
  <th colspan="2" style="padding:2px;font-size:0.7rem;">Issue Date</th>
  <td style="padding:2px;font-size:0.7rem;border-right:1px dashed black;" class="text-capitalize"><?php echo $dates; ?></td>
  <td></td>
  <th colspan="2" style="padding:2px;font-size:0.7rem;">Issue Date</th>
  <td style="padding:2px;font-size:0.7rem;" class="text-capitalize"><?php echo $dates; ?></td>
</tr>
<tr>
  <th style="border:1px solid black;padding:2px;font-size:0.7rem;width:10px;">#</th>
  <th style="border:1px solid black;padding:2px;font-size:0.7rem;width:70px;">Description</th>
  <th style="border:1px solid black;padding:2px;font-size:0.7rem;border-right:1px dashed black;">Amount</th>
  <th></th>
  <th style="border:1px solid black;padding:2px;font-size:0.7rem;width:10px;">#</th>
  <th style="border:1px solid black;padding:2px;font-size:0.7rem;width:70px;">Description</th>
  <th style="border:1px solid black;padding:2px;font-size:0.7rem;border-right:1px dashed black;">Amount</th>
  <th></th>
  <th style="border:1px solid black;padding:2px;font-size:0.7rem;width:10px;">#</th>
  <th style="border:1px solid black;padding:2px;font-size:0.7rem;">Description</th>
  <th style="border:1px solid black;padding:2px;font-size:0.7rem;">Amount</th>
</tr>
<tr>
  ...
  <td></td>
  <th style="border:1px solid black;padding:2px;font-size:0.7rem;width:10px;">1</th>
  <th style="padding:2px;font-size:0.7rem;border:1px solid black;">M.Fee (<?php echo $monthName; ?>)</th>
    <td style="padding:2px;font-size:0.7rem;border:1px solid black;"><?php echo $monthly_fees; ?></td>
  <td></td>
  <th style="border:1px solid black;padding:2px;font-size:0.7rem;width:10px;">1</th>
...
<tr>
  <th style="border:1px solid black;padding:2px;font-size:0.7rem;width:10px;">2</th>
...
<tr>
  ...
  <th style="padding:2px;font-size:0.7rem;border:1px solid black;">Balance <?php echo $mnths; ?></th>
...
<tr>
  <th colspan="2" style="border:1px solid black;font-weight:bold;font-size:0.9rem;">Due Date</th>
...
<tr>
  <th colspan="2" style="border:1px solid black;font-weight:bold;font-size:0.9rem;">After Due Date</th>
  <td class="fs-6" style="border:1px solid black;">
  <?php  
$latdte = date("d");
 if($fees_statuss == "Unpaid"){
...
<tr>
<td style="padding:2px;font-size:0.7rem;border-right:1px dashed black;" colspan='3'><b>Note:</b> 
<ul>
...
<ul>
    ...
    <li style="padding:2px;font-size:0.7rem;">We have the right to take legal action.</li>
              ...
              <td width='20'></td>
<td style="padding:2px;font-size:0.7rem;" colspan='3'><b>Note:</b>
<ul>
    <li style="padding:2px;font-size:0.7rem;">Dues must be paid till due date <span style="padding:2px;font-size:0.7rem;" class="fw-bolder">
        (<?php if(!empty($due_dates)){ echo $dusdts; }else{ echo "Nill"; } ?>).</li>
    <li style="padding:2px;font-size:0.7rem;">After due date Fine will be Charged Rs <?php if(!empty($latfefund)){ echo $latfefund."/"; }else{ echo "_____"; } ?>.</li>
...
<tr>
    <td style="border:1px solid black;padding:2px;font-size:0.8rem;text-align:center;" colspan='3'><b style="font-size:0.8rem;">Address:</b> <?php echo $address; ?><b style="font-size:0.8rem;"><br>Cell:</b> <?php echo $fmcels; ?></td>
