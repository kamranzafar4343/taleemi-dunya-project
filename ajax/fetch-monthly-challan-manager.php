...
<tr align="center" id="'.$id.'" style="background:hsl(35, 100%, 80%);">
    ...
    <td style="border:1px solid hsl(25, 100%, 50%);"><input value="'.$roll_num.'" style="width:70px;" readonly></td>
    ...
    <td style="border:1px solid hsl(25, 100%, 50%);">
        <a href="challan-specimen?id='.$id.'" target="_blank" class="btn">
            <i class="fa-solid fa-file-invoice" style="color:hsl(330,100%,50%);"></i>
        </a>
    </td>
    <td style="border:1px solid hsl(25, 100%, 50%);"><a href="family-challan-specimen?id='.$roll_num.'" target="_blank" class="btn"><i class="fa-solid fa-file-invoice" style="color:hsl(270,100%,50%);"></i></a></td>
