...
<th class="p-1">
   ...
   <div><span class="text-capitalize fs-4" style="border-bottom:1px solid black;"><?php echo $campus; ?></span></div>
        ...
        <th width="100" class="p-1"><img src="student_imgs/<?php if(empty($student_img)){ echo "users.jpg"; }elseif($student_img == "None"){ echo "users.jpg"; }elseif($student_img == "none"){ echo "users.jpg"; }else{ echo $student_img; } ?>" class="img-fluid"></th>    
</tr>
    <tr align="center" style='background:hsl(35, 100%, 80%);'>
