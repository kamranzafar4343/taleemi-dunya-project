...
<div class="row">
    <div class="col-12 mb-3">
        <input type="hidden" class="form-control" id="phones" value="<?php echo $fromcel; ?>">
...
<button type="button" id="send-app" class="btn btn-success text-capitalize"><i class="fa-brands fa-whatsapp"></i> Send on APP SMS</button>
    </div>
</div>
<script>
$(document).ready(function(){
    $("#send-app").on('click',function(){
Swal.fire({
  title: 'If You allow the SMS, You will purchase the brand SMS from PTA',
  showClass: {
