...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active text-capitalize" aria-current="page"> individual report</li>
  </ol>
</nav>                
            </div>
        </div>
...
$.ajax({
    url: 'ajax/staff-individual-attendance-report.php',
    type: "POST",
    data: {aply_sesion:sesins,aply_instute:instutes,aply_mnths:mnths,aply_stafid:stfids},
