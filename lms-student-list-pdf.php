...
$html .= "<tr><td>".$ai++."</td><td>$admissionDate</td><td style='text-transform:capitalize;'>$studentName</td><td style='text-transform:capitalize;'>$fatherName</td><td style='text-transform:capitalize;'>$class_name</td><td style='text-transform:capitalize;'>$section</td><td>$session</td><td>$bForm</td><td>$roll_num</td><td style='text-transform:capitalize;'>$gender</td></tr>";
    }
$html .= "</table>";
}else{
