...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active text-capitalize" aria-current="page"> staff attendance report</li>
  </ol>
</nav>                
            </div>
        </div>
...
<div class="text-capitalize">address: <span class="fw-normal"><?php echo $mainaddress; ?></span> </div>
    ...
    <tr align="center">
        ...
        <th style="padding:2px;font-size:0.9rem;">Staff Name</th>
...
$newdt = date("j-m-Y");
$sl_stud = mysqli_query($con,"select * from staffAttendance where instituteId='$userId' && date='$newdt' order by id desc");
...
<tr align="center">
    ...
    <td style="padding:2px;font-size:0.9rem;" width="20"><img src="staff_imgs/<?php echo $staffimages; ?>" class="img-fluid"></td>
    <td style="padding:2px;font-size:0.9rem;"><?php echo $staff_name; ?></td>
    <td style="padding:2px;font-size:0.9rem;"><?php echo $father_name; ?></td>
    <td style="padding:2px;font-size:0.9rem;"><?php echo $post; ?></td>
    <td style="padding:2px;font-size:0.9rem;"><?php echo $staffType; ?></td>
