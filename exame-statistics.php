...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active text-capitalize" aria-current="page"> exame statistics</li>
  </ol>
</nav>                
            </div>
        </div>
...
$.ajax({
url: 'ajax/fetch-exame-statistics-record.php',
type: "POST",
data: {inst_id:inst,aply_sesion:sesn,aply_trms:temss},
