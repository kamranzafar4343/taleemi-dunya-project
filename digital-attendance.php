...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active text-capitalize" aria-current="page"> digital attendance</li>
  </ol>
</nav>                
            </div>
        </div>
...
<form id="addForm">  
<input type="text" class="form-control" autocomplete="off" required id="live_search" onkeypress="isInputNumber(event)">
</form>
