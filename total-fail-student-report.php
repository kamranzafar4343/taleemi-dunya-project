...
$newdt = date("j-m-Y");
$sl_stud = mysqli_query($con,"select * from addStudents where instituteId='$userId' && admissionDate='$newdt' order by id desc");
...
<tr align="center">
    ...
    <td width="50"><img src="student_imgs/<?php echo $image; ?>" class="img-fluid"></td>
