...
<tr align="center" style="background:hsl(35, 100%, 80%);">
    ...
    <td style="border:1px solid hsl(25, 100%, 50%);" width="50"><img class="img-fluid" src="../student_imgs/<?php if(empty($image) || $image == "None" || $image == "NONE" || $image == "none"){ echo "users.jpg"; }else{ echo $image; } ?>"><input name="snap[]" type="hidden" value="<?php echo $image; ?>"></td>
