...
<div class="col-12 mb-4">
    <div class="card p-3" style='background-color:hsla(120,100%,15%,0.4);border:1px solid hsla(120,100%,15%,0.7);color:white;border-radius:5px;'><?php echo $message; ?></div>
</div>
<?php
    }
