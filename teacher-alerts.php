...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active text-capitalize" aria-current="page"> teacher alerts</li>
  </ol>
</nav>                
            </div>
        </div>
...
<div class="container-fluid mt-4">
    <form class="serchAlrtFrm">
<div class="row">
    <div class="col-6 col-sm-4 col-md-3 col-lg-2 col-xl-2 col-xxl-2">
        <input type="hidden" value="<?php echo $userId; ?>" id="insti">
...
<?php } ?>
    ...
    <div class="col-6 col-sm-4 col-md-3 col-lg-2 col-xl-2 col-xxl-2">
        <div class="d-grid">
            <button id="btngenattendance" type="submit" class="btn btn-apna text-uppercase"><i class="fas fa-redo"></i> Generate</button>
        </div>
    </div>    
</div>
    </form>
...
<div class="row">
    <div class="col">
<div class="stf-techr-alts"></div>
    </div>
</div>
<script>
$(document).ready(function(){
    $("#btngenattendance").on('click',function(e){
e.preventDefault();
var insti = $("#insti").val();
var sesin = $(".sesin").val();

$.ajax({
    url: 'ajax/fetch-staff-for-alerts.php',
    type: "POST",
    data: {inst_ids:insti,sesins:sesin},
    success: function(results){
$(".stf-techr-alts").html(results);
    }
});
