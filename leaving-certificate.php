...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active text-capitalize" aria-current="page"> leaving certificate</li>
  </ol>
</nav>                
            </div>
        </div>
...
<div class="row">
<h4 class="fs-4 fw-bold text-uppercase mb-3 mt-3 text-white" style="border-bottom:2px dashed white;">leaving certificates</h4>
<?php
if(isset($_GET['id'])){
    $ids = $_GET['id'];
...
<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12 datas">
    <div class="card">
        <img src="logo/leaving-certificate.webp" class="card-img-top">
...
<div class="row">
    <div class="col-8 col-sm-8 col-md-8 col-lg-8 col-xl-8 col-xxl-8 offset-2 offset-sm-2 offset-md-2 offset-lg-2 offset-xl-2 offset-xxl-2">
        <h6 class="fs-6" style="text-align: justify; text-justify: inter-word;">
It Is To Certify That <span class="text-danger text-uppercase fs-6"><?php echo $studentName;?></span> S/D/O <span class="text-danger text-uppercase fs-6"><?php echo $fatherName; ?></span> Appeared As A Private<br><br> Student To This Institution In <span class="text-danger text-uppercase fs-6"><?php echo $class_name; ?></span> Class Under Roll No <span class="text-danger text-uppercase fs-6"><?php echo $roll_num; ?></span> In Final Term <br><br>Examination Held In Dec- <?php echo $session; ?>.
        </h6><br><br>
        <h6 class="text-success text-uppercase">HIS / HER CONDUCT DURING THE SCHOOL STAY REMAINED GOOD. I WISH HIM/HER EVERY SUCCESS IN ALL WORKS OF LIFE IN FUTURE.</h6>
    </div>
</div>
        </div>
    </div>
