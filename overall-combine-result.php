...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active text-capitalize" aria-current="page"> Combine Result Card</li>
  </ol>
</nav>                
            </div>
        </div>
...
$.ajax({
    url:'ajax/fetch-all-students-combine-result.php',
    type:"POST",
    data: {aply_cles:cls,sectns:strngs,aply_inst:instutes,aply_sesin:sesins},
    success: function(cmbmethods){ $(".view-result-cards").html(cmbmethods); }
});
}
    });
});
