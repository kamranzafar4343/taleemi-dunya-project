...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active text-capitalize" aria-current="page"> Class Wise Paid / Unpaid List</li>
  </ol>
</nav>                
            </div>
        </div>
...
Toast.fire({
  ...
  title: "Select Session!"
    ...
    $.ajax({
url: 'ajax/fetch-class-wise-receive-collection.php',
type: "POST",
data: {aply_clas:cles,colg_id:colctId,aply_sectin:sectn,aply_sesin:sesin,manths:mnths,aply_status:staus},
