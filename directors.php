...
<div class="container-fluid mb-5">
    <div class="row">
        ...
        if (mysqli_num_rows($sl_inst) > 0) {
            ...
            echo "<div class='text-capitalize'>update your school profile!</div>";
        }
                ...
                <div class="row mb-5">
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-3 col-xl-2 col-xxl-2">
                        <div class="card mb-3 text-center px-4 py-2 cards">
                            <a href="javascript:void()" onclick="location.href='dashboard.php'" class="nav-link box">
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-3 col-xl-2 col-xxl-2">
                        <div class="card mb-3 text-center px-4 py-2 cards">
                            <a href="javascript:void()" onclick="location.href='add-staffs.php'" class="nav-link box">
...
End collection Manager----->
                    ...
                    <!---End Accounts----->
                    <!---Start Settings----->
                    <?php if ($email == "demoadmin@gmail.com") {
                    } else { ?>
                        <div class="col-6 col-sm-4 col-md-3 col-lg-3 col-xl-2 col-xxl-2">
                            <div class="card mb-3 text-center px-4 py-2 cards">
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-3 col-xl-2 col-xxl-2">
                        <div class="card mb-3 text-center px-4 py-2 cards">
                            <a href="javascript:void()" onclick="location.href='reminders.php'" class="nav-link box">
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-3 col-xl-2 col-xxl-2">
                        <div class="card mb-3 text-center px-4 py-2 cards">
                            <a href="javascript:void()" onclick="location.href='call-log.php'" class="nav-link box">
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-3 col-xl-2 col-xxl-2">
                        <div class="card mb-3 text-center px-4 py-2 cards">
                            <a href="javascript:void()" onclick="location.href='social-posts.php'" class="nav-link box">
