...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active text-capitalize" aria-current="page"> today received fee report</li>
  </ol>
</nav>                
            </div>
        </div>
...
$newdt = date("j-m-Y");
$sl_stud = mysqli_query($con,"select * from fee_collection where instituteId='$userId' && fees_status='paid' && dates='$newdt' order by id desc");
...
$receive_month += $rows['receive_monthly'];
...
<tr align="center">
    ...
    <td class="text-capitalize" style="padding:2px;font-size:0.9rem;"><?php echo $student_name; ?></td>
    <td class="text-capitalize" style="padding:2px;font-size:0.9rem;"><?php echo $father_name; ?></td>
    <td class="text-capitalize" style="padding:2px;font-size:0.9rem;"><?php echo $class; ?></td>
    <td class="text-capitalize" style="padding:2px;font-size:0.9rem;"><?php echo $section; ?></td>
    ...
    <td class="text-capitalize" style="padding:2px;font-size:0.9rem;"><?php echo $fees_status; ?></td>
    <input type="hidden" value="<?php echo $userId; ?>" name="inst_id">
</tr>
<?php } ?>
<tr align="right">
    <th colspan="4">Received Amount: </th>
    <th colspan="6"><?php echo $receive_month; ?></th>
</tr>
</form>
