...
<div class="input-group mb-4">
    ...
    <input type="hidden" id="mnthlyfe" class="form-control" required value="<?php echo $month; ?>">
    <input type="hidden" id="sesinsaply" class="form-control" required value="<?php echo $session; ?>">
</div>
</form>
        </div>
    </div>
...
function collectionForm(){
    ...
    var usrid = $("#usrid").val();
    var mnthlyfe = $("#mnthlyfe").val();
    var sesinsaply = $("#sesinsaply").val();
$.ajax({
    url: 'ajax/fetch-collection-form-by-id.php',
    type: "POST",
    data: {ins_ids:institue,st_ieds:usrid,month_fes:mnthlyfe,sesin_aply:sesinsaply},
