...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a class="text-white text-capitalize text-decoration-none" href="javascript:void()" onclick="location.href='student-wise-installments'"> student wise installments</a></li>
    <li class="breadcrumb-item active text-capitalize" aria-current="page"> Edit installment Challan Form</li>
  </ol>
</nav>    
            </div>
        </div>
