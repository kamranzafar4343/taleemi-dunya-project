      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6 mb-3">
            <div class="card mb-3 text-center">
              <a href="javascript:void()" onclick="location.href='manual-attendance.php'" class="text-uppercase p-3 bg-white nav-links">student manual attendance</a>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6 mb-3">
            <div class="card mb-3 text-center">
              <a href="javascript:void()" onclick="location.href='digital-attendance.php'" class="text-uppercase p-3 bg-white nav-links">student digital attendance</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6 mb-3">
            <div class="card mb-3 text-center">
              <a href="javascript:void()" onclick="location.href='staff-manual-attendance.php'" class="text-uppercase p-3 bg-white nav-links">staff manual attendance</a>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6 mb-3">
            <div class="card mb-3 text-center">
              <a href="javascript:void()" onclick="location.href='staff-digital-attendance.php'" class="text-uppercase p-3 bg-white nav-links">staff digital attendance</a>
            </div>
          </div>
        </div>
      </div>
