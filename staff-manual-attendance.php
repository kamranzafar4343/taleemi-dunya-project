...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active text-capitalize" aria-current="page">staff manual attendance</li>
  </ol>
</nav>                
            </div>
        </div>
...
<div class="row">
    ...
    <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2 col-xxl-2">
        <input type="hidden" value="<?php echo $userId; ?>" class="inst">
        <label class="text-capitalize">session</label>
<select class="form-select sesines">
<?php
...
<br><br>
<div class="attendance-sheet"></div>
<script>
...
Toast.fire({
  ...
  title: "Please Select Date!"
    ...
    $.ajax({
url: 'ajax/fetch-staff-attendance-sheet.php',
type: "POST",
data: {aply_dates:dtes,aply_inst:inst,aply_sesion:sesines},
success: function(blots){
    $(".attendance-sheet").html(blots);
}
    });
}
    });
