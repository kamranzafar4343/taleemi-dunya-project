...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active text-capitalize" aria-current="page"> create combine results card</li>
  </ol>
</nav>                
            </div>
        </div>
...
<div class="row">
    <div class="col-6 col-sm-4 col-md-3 col-lg-2 col-xl-2 col-xxl-2">
        ...
        <input type="text" class="form-control rlno" onkeypress="isInputNumber(event)" placeholder="xxxxxxxxx">
    </div>
    <div class="col-6 col-sm-4 col-md-3 col-lg-2 col-xl-2 col-xxl-2">
...
Toast.fire({
  ...
  title: "Please Check the Terms!"
    ...
    $.ajax({
url: 'ajax/create-students-combine-result-card.php',
type: "POST",
