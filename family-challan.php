...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active text-capitalize" aria-current="page"> family Collection</li>
  </ol>
</nav>                
            </div>
        </div>
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-6 col-sm-4 col-md-3 col-lg-2 col-xl-2 col-xxl-2 mb-3">
            <label class="text-capitalize fs-6">enter family#</label>
    <input type="text" id="serch_vls" class="form-control" required placeholder="Enter Family# Search" onkeypress="isInputNumber(event)" autocomplete="off">
    ...
    <input type="hidden" id="usrrols" class="form-control" required value="<?php echo $role; ?>">
        ...
        <div class="col-6 col-sm-4 col-md-3 col-lg-2 col-xl-2 col-xxl-2 mb-3">
            <label class="text-capitalize fs-6">Select Month</label>
        ...
        <div class="col-6 col-sm-4 col-md-3 col-lg-2 col-xl-2 col-xxl-2 mb-3">
            ...
            <select class="form-select adsesin">
    <?php
    ...
    ?>
        ...
        <div class="col-6 col-sm-4 col-md-2 col-lg-2 col-xl-2 col-xxl-2 mb-3 mt-4">
            <div class="d-grid">
                <button class="btn btn-apna text-capitalize" type="submit" id="searchbtn"><i class="fa fa-search"></i> search</button>
            </div>
        </div>
    </div>
</form>
...
Toast.fire({
  ...
  title: 'Please Enter Roll#'
    ...
    $.ajax({
url: 'ajax/paid-monthly-charges-by-family.php',
type: "POST",
data: {fmly_nbr:serch_vls,inst_id:institue,user_role:usrrols,aply_months:mnths,aply_sesions:adsesin},
