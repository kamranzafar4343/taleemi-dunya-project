...
$nws = date("j-m-Y");
$mnth = date("m");
$sl_stud = mysqli_query($con,"select * from addStock where instituteId='$userId' && month='$mnth' order by id desc");
...
<div align='right' class='p-5'>
  <button class='btn btn-success' id="btn_printed"><i class="fa fa-print"></i> Print</button>
</div>
    </div>
</div>
</div>
