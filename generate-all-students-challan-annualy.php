...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active text-capitalize" aria-current="page"> challan generate all students annualy</li>
  </ol>
</nav>                
            </div>
        </div>
...
<tr>
    <td colspan="10" align="right">
        <button type="submit" class="btn btn-apna" name="but_generate"> <i class="fa-solid fa-arrows-rotate"></i> All Challan Generate </button>
    </td>
</tr>
</form>
<?php } ?>
...
if($inst_feea){ echo "<script>swal.fire('Good Job!','Successfully All Students Challan Generated.','');</script>"; }else{ echo "<script>swal.fire('Oops!','All Students Challans is not Generate.','error');</script>"; }
}else{
echo "<script>swal.fire('Sorry!','This Month Challan Generate.','info');</script>";
    }
}
