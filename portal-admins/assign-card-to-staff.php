...
if(isset($_GET['id'])){
    $ids = $_GET['id'];
$sl_nmbr = mysqli_query($con,"select * from addStaff where id='$ids'");
...
<main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1 class="text-capitalize">Assign Number to <?php echo $staffName; ?></h1>
      <nav>
        <ol class="breadcrumb">
...
if(isset($_POST['btn_crd'])){
    $nmbrs = $_POST['nmbrs'];
$updt = mysqli_query($con,"update addStaff set digitalCard='$nmbrs' where id='$ids'");
if($updt){
    echo "<script>
