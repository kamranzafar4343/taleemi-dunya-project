    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active text-capitalize">monthly invoice generate</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
...
<div class="card">
    <div class="card-body">
        <h5 class="card-title text-capitalize">monthly invoice generate</h5>
...
<?php
$a = 1;
$sl_inv = mysqli_query($con,"select * from confirmSchools where assign_role='director' && plan='Monthly'");
...
<tr>
    <th><?php echo $a++; ?></th>
    <td><input style="width:70px;" type="text" value="<?php echo $institute_id; ?>"></td>
...
<?php }else{ ?>
<a href="generate-monthly-invoice?id=<?php echo $id; ?>" class="btn btn-success text-capitalize"><i class="bi bi-receipt-cutoff"></i> generate</a>
<?php } ?>
    </td>
</tr>
</form>
