...
<?php if($userId == 705834){ ?>
    <div class="col-12 col-sm-6 col-md-6 col-lg-4 col-xl-4 col-xxl-4">
        <div class="card mb-3 text-center">
            <a href="javascript:void()" onclick="location.href='all-students'" class="nav-links text-uppercase bg-white p-3 px-4">all-students</a>
        </div>
    </div>
    <div class="col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3 col-xxl-3">
        <div class="card mb-3 text-center">
            <a href="javascript:void()" onclick="location.href='class-wis-student-lists'" class="nav-links text-uppercase bg-white p-3 px-4">class wise student list</a>
        </div>
    </div>
    <div class="col-12 col-sm-6 col-md-6 col-lg-4 col-xl-4 col-xxl-4">
        <div class="card mb-3 text-center">
            <a href="javascript:void()" onclick="location.href='struck-off-manager'" class="nav-links text-uppercase bg-white p-3 px-4">Struck Off Manager</a>
        </div>
    </div>
    <div class="col-12 col-sm-6 col-md-6 col-lg-4 col-xl-4 col-xxl-4">
        <div class="card mb-3 text-center">
<a href="javascript:void()" onclick="location.href='left-students-manager'" class="nav-links text-uppercase bg-white p-3 px-4">left students Manager</a>
        </div>
    </div>
    <div class="col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3 col-xxl-3">
        <div class="card mb-3 text-center">
            <a href="javascript:void()" onclick="location.href='computer-college-defaulter-students'" class="nav-links text-uppercase bg-white p-3 px-4">Defaulter students</a>
        </div>
    </div>
<?php }else{ ?>
    <div class="col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3 col-xxl-3">
    ...
    <div class="col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3 col-xxl-3">
        <div class="card mb-3 text-center">
            <a href="javascript:void()" onclick="location.href='defaulter-students'" class="nav-links text-uppercase bg-white p-3 px-4">Defaulter students</a>
        </div>
    </div>
...
<div class="col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3 col-xxl-3">
    ...
    <div class="col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3 col-xxl-3">
        <div class="card mb-3 text-center">
            <a href="javascript:void()" onclick="location.href='sibling-manager'" class="nav-links text-uppercase bg-white p-3 px-4">Sibling Manager</a>
        </div>
    </div>
<?php } ?>    
</div>
